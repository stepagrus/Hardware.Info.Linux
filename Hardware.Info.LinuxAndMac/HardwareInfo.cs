...
namespace Hardware.Info.LinuxAndMac
{
    public class HardwareInfo : IHardwareInfo
    {
        ...
        public HardwareInfo()
        {
            ...
            {
                _hardwareInfoRetrieval = new Linux.HardwareInfoRetrieval();
            }
            else if (RuntimeInformation.IsOSPlatform(OSPlatform.OSX))
            {
                _hardwareInfoRetrieval = new Mac.HardwareInfoRetrieval();
            }
            else
            {
                throw new NotSupportedException($"The {RuntimeInformation.OSDescription} operating system is not supported");
            }
        }
